            ...
            <div className="flex items-center space-x-4">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="outline" className="border-slate-200 hover:border-blue-300 bg-transparent">
          ...
          {filteredTemplates.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {filteredTemplates.map((template, index) => (
                <Card
                  key={template.id}
                  className="group hover:shadow-2xl hover:shadow-blue-500/10 transition-all duration-500 border-0 shadow-lg hover:-translate-y-2 bg-white/80 backdrop-blur-sm animate-fade-in-up cursor-pointer"
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex space-x-2 pt-2">
                        <Button
                          ...
                          variant="outline"
                          size="sm"
                          className="flex-1 border-slate-300 hover:border-blue-400 bg-white hover:bg-blue-50"
                        >
                          <Eye className="w-4 h-4 mr-2" />
                          Preview
                        </Button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {templates
                ...
                .map((template, index) => (
                  <Card
                    key={template.id}
                    className="group hover:shadow-2xl transition-all duration-500 border-0 shadow-lg hover:-translate-y-2 bg-gradient-to-br from-white to-blue-50/30"
                  >
