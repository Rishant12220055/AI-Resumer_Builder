  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50">
          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-4">
              <Link href="/auth/login">
                <button className="text-slate-600 hover:text-blue-600 font-medium transition-all duration-300 hover:scale-105 px-4 py-2 rounded-lg hover:bg-slate-100">
                  Sign In
                </button>
              </Link>
              <Link href="/auth/signup">
                <button className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/30 transition-all duration-300 font-semibold hover:scale-105 px-6 py-2 rounded-lg">
                  Get Started Free
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="space-y-6">
                <span className="inline-block bg-gradient-to-r from-blue-600 to-indigo-600 text-white border-0 shadow-lg shadow-blue-500/25 text-sm font-semibold px-4 py-2 rounded-full animate-bounce-subtle">
              ...
              <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-up animation-delay-1200">
                <Link href="/auth/signup">
                  <button className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-xl shadow-blue-500/25 hover:shadow-2xl hover:shadow-blue-500/30 transition-all duration-300 group text-lg font-bold px-8 py-6 hover:scale-105 rounded-lg">
                    Start Building Free
                    <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform inline" />
                  </button>
                </Link>
                <button className="border-2 border-slate-300 hover:border-blue-500 hover:text-blue-600 group bg-white/80 backdrop-blur-sm text-lg font-semibold px-8 py-6 hover:scale-105 transition-all duration-300 rounded-lg">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="inline-block bg-blue-50 text-blue-700 mb-6 text-lg font-semibold px-6 py-3 rounded-full animate-bounce-subtle">
              Powerful Features
            </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className={`group hover:shadow-2xl ${feature.glow} hover:shadow-2xl transition-all duration-500 border-0 shadow-lg hover:-translate-y-3 bg-gradient-to-br from-white to-slate-50/50 animate-fade-in-up rounded-xl p-8`}
                style={{
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="inline-block bg-gradient-to-r from-blue-600 to-indigo-600 text-white mb-6 text-lg font-semibold px-6 py-3 rounded-full animate-bounce-subtle">
              How It Works
            </span>
            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className="border-0 shadow-xl hover:shadow-2xl transition-all duration-500 bg-gradient-to-br from-white to-slate-50/50 hover:-translate-y-2 hover:scale-105 animate-fade-in-up rounded-xl p-8"
                style={{
                  animationDelay: `${index * 200}ms`,
                }}
              >
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {/* Free Plan */}
            <div className="border-2 border-slate-200 shadow-xl hover:shadow-2xl transition-all duration-500 bg-white hover:scale-105 animate-fade-in-up rounded-xl p-8">
              ...
              <Link href="/auth/signup" className="block">
                <button className="w-full bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold text-lg py-6 hover:scale-105 transition-all duration-300 rounded-lg">
                  Get Started Free
                </button>
              </Link>
            </div>
            ...
            {/* Pro Plan */}
            <div className="border-2 border-blue-500 shadow-2xl relative bg-gradient-to-br from-white to-blue-50/30 hover:scale-105 transition-all duration-500 animate-fade-in-up animation-delay-200 rounded-xl p-8">
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                <span className="inline-block bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-lg font-bold px-6 py-2 rounded-full shadow-lg animate-bounce-gentle">
                  Most Popular
                </span>
              </div>
              <div className="text-center mb-8">
              ...
              <Link href="/auth/signup" className="block">
                <button className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold text-lg py-6 shadow-lg shadow-blue-500/25 hover:scale-105 transition-all duration-300 rounded-lg">
                  Start Pro Trial
                </button>
              </Link>
            </div>
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center animate-fade-in-up animation-delay-600">
            <Link href="/auth/signup">
              <button className="bg-white text-blue-600 hover:bg-blue-50 shadow-xl hover:shadow-2xl transition-all duration-300 group font-bold text-lg px-10 py-6 hover:scale-110 rounded-lg">
                Start Building Now
                <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform inline" />
              </button>
            </Link>
            <Link href="/auth/login">
              <button className="border-2 border-white text-white hover:bg-white hover:text-blue-600 bg-transparent font-bold text-lg px-10 py-6 hover:scale-110 transition-all duration-300 rounded-lg">
                Sign In
              </button>
            </Link>
          </div>
